  ...
  <div class="bg-white shadow-lg rounded-2xl p-8 w-full max-w-2xl space-y-8">
    ...
    <div class="text-center space-y-4">
      ...
      <p class="text-gray-600 text-base">
        I am a PATH rider who wants a <span class="font-semibold text-blue-700"><TypeWriter typeSpeed={120} deleteSpeed={100} afterTyped={{blink: 4.5}} afterDeleted={{blink: 4.5}} blinkDuration={100000000000} texts={['better', 'safer', 'faster', 'more efficient', 'more courteous']}/></span>experience.
      </p>
